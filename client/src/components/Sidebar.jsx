      ...
      <aside className="bg-primary w-full max-w-[420px] 3xl:max-w-[629px] h-screen p-5 3xl:p-8 ">
        <div className="relative h-full">
          <div className="flex items-center justify-between mb-5">
            <h1 className="text-white text-[48px] font-comfortaa">
              wendy
              <span className="text-[36px] text-secondary">ai</span>{" "}
            </h1>

            <img src={avataricon} alt="avatar" />
          </div>

          <button className="flex items-center border border-[#463d6d] font-roboto text-[28px] px-3 py-2 text-white w-full transition-all ease-linear duration-200  hover:border-white">
            <PlusIcon />
            <span className="ml-3">Chat History</span>
          </button>

          <ul className="my-8 overflow-auto max-h-[calc(100vh-300px)]">
            <li className="flex items-center font-roboto text-white text-[28px] mb-3">
              <ChatIcon />
              <p className="ml-3">
